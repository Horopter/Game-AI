import FENChess from "../../src/FENChess/index.js";
...
function newBoard() {
  // Initialize FENChess with the standard starting FEN.
  const b = new FENChess();
  b.currentTurn = "white";
  return b;
}

function runTests() {
  console.log("Starting 27-bitflag FENChess comprehensive tests...");
  ...
  board = newBoard();
  board.getGameState()[5][0] = { type: "pawn", color: "white" };
  move = { from: { row: 6, col: 0 }, to: { row: 5, col: 0 } };
  result = board.validateMove(move);
  ...
  board = newBoard();
  board.getGameState()[5][3] = { type: "pawn", color: "black" };
  ...
  board = newBoard();
  board.getGameState()[7][1] = null;
  board.getGameState()[7][2] = null;
  board.getGameState()[7][3] = null;
  move = { from: { row: 7, col: 0 }, to: { row: 7, col: 3 } };
  result = board.validateMove(move);
  ...
  board = newBoard();
  board.getGameState()[7][4] = null;
  board.getGameState()[7][5] = null;
  ...
  board = newBoard();
  board.currentTurn = "black";
  board.getGameState()[7][3] = null; // clear destination
  move = { from: { row: 7, col: 1 }, to: { row: 7, col: 3 } };
  result = board.validateMove(move);
  ...
  board = newBoard();
  board.getGameState()[5][1] = { type: "pawn", color: "white" };
  ...
  assertEqual(board.getGameState()[6][0], null, "Test 26 failed: Pawn source square not empty after execution", board, move);
  if (board.getGameState()[5][0] === null) {
  ...
  console.log("All 27 FENChess tests passed successfully.");
}
